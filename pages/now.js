...
export default function Now(currentlyReading) {
  ...
  var GowthamBirthDate = '2002-10-05'
  var birthDate = new Date(GowthamBirthDate)

  var GowthamAge = year - birthDate.getFullYear()

  var GowthamMonth = 0
  if (month >= birthDate.getMonth()) GowthamMonth = month - birthDate.getMonth()
  else {
    GowthamAge--
    GowthamMonth = 12 + month - birthDate.getMonth()
  }

  var GowthamDay = 0
  if (date >= birthDate.getDate()) GowthamDay = date - birthDate.getDate()
  else {
    GowthamMonth--
    GowthamDay = 31 + date - birthDate.getDate()
    if (GowthamMonth < 0) {
      GowthamMonth = 11
      GowthamAge--
    }
        ...
        <div>
          <div className="flex justify-between gap-5">
            <div className="mt-2 mb-10 w-1/2 rounded-md border border-gray-600 p-1 text-sm dark:border-gray-200">
              <span className="ml-2 font-semibold">Location:</span> <span>AndraPradesh, India</span>
              <br />
